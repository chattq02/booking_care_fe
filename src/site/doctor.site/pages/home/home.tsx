  ...
  const menuItems = [
    {
      ...
      label: screens.xs ? null : "Dashboard",
    },
    {
      key: "appointments",
      icon: <CalendarOutlined />,
      label: screens.xs ? null : "Lịch hẹn",
    },
    {
      key: "patients",
      icon: <TeamOutlined />,
      label: screens.xs ? null : "Bệnh nhân",
    },
    {
      key: "medical-records",
      icon: <FileTextOutlined />,
      label: screens.xs ? null : "Hồ sơ",
    },
    {
      key: "messages",
      icon: <MessageOutlined />,
      label: screens.xs ? null : "Tin nhắn",
      badge: 3,
    },
    {
      key: "schedule",
      icon: <ClockCircleOutlined />,
      label: screens.xs ? null : "Lịch làm việc",
    },
    {
      key: "settings",
      icon: <SettingOutlined />,
      label: screens.xs ? null : "Cài đặt",
    },
  ];
      ...
      {currentPatient ? (
        <Space direction="vertical" style={{ width: "100%" }}>
          ...
          <Button
            ...
            icon={<CheckOutlined />}
            onClick={() =>
              alert(`Hoàn thành khám cho ${currentPatient.patientName}`)
            }
          >
            Hoàn thành khám
          </Button>
  ...
  return (
    <Layout>
                ...
                <Col xs={12} sm={12} md={12} lg={24} xl={12}>
                  <div style={{ textAlign: "center" }}>
                    <Progress
                      ...
                      format={(percent) => (
                        <div style={{ fontSize: screens.xs ? "14px" : "16px" }}>
      ...
      <Modal
        ...
        footer={[
          <Button key="close" onClick={() => setIsPatientModalVisible(false)}>
            Đóng
          </Button>,
          <Button
            key="start"
            ...
            onClick={() => {
              if (selectedPatient) {
                handleSwitchPatient(selectedPatient.id);
        ...
        {selectedPatient && (
          <Descriptions column={2} bordered>
            ...
            <Descriptions.Item label="Ngày">
              {dayjs(selectedPatient.date).format("DD/MM/YYYY")}
            </Descriptions.Item>
